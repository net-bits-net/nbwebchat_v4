...
var langr = {
    ...
    l_connecting: function (ip, port) { return "Connecting to " + ip + ":" + port + "." },
    l_connected: "Connected",
    l_couldnotconnect: function (address) { return "Could not connect, retrying again in few seconds." },
    l_reconnecting_immediate: "Re-connecting...",
    l_reconnecting_delayed: "Re-connecting in few seconds...",
    ...
    l_youareinvited: function (nick) { return "<i class=\"fa fa-info-circle\" aria-hidden=\"true\"></i> You have invited \"" + nick + "\" to this room." },
    l_version: "Version:",
    l_commandlinessupported: function (commands_list) { return "Commandline commands supported in this client: " + commands_list + ". Commands must start with /" },
    ...
    l_knock: "KNOCK",
    l_knocked_a: "knocked.", //this is without and with the message, todo later.
    l_knocked_b: "Message:",
    l_blockedinviteflood: "Blocked invite flood.",
    l_hasinvitedyou: "has invited you to chat room:",
    l_blockedinvite: function (nick) { return "<i class=\"fa fa-info-circle\" aria-hidden=\"true\"></i> Blocked invite from \"" + nick + "\" for security reason(s)." },
    l_enterkey: "Enter room key:",
    l_enterkickmsg: "Enter Kick Message",
    l_enternickname: "Enter_Your_Nickname_Here",
    l_nickmorethan2chrs: "<i class=\"fa fa-exclamation-triangle\" aria-hidden=\"true\"></i> Nickname must be more than 3 characters.",
    ...
    l_whispermax: "[<i class=\"fa fa-exclamation-triangle\" aria-hidden=\"true\"></i>: Instances of whisper windows have exceeded max limit. If you want to open new whispers conversation in new window, then close some whisper windows.",
    ...
    l_error433: function (nick) { return "<i class=\"fa fa-exclamation-triangle\" aria-hidden=\"true\"></i> Nickname \"" + nick + "\" is in use, trying another nick name." },
...
//# sourceMappingURL=nblang30.js.map